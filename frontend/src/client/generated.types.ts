...
export interface Assistant {
  ...
  supports_user_directives: boolean;
}
...
export interface API {
  ...
  chat: {
    ...
    load_chat(args: { chat_id: string }): Chat;
...
// otto/otto/api/types.py
export interface RealtimeTurnEnd {
  id: string;
  chat_id: string;
  type: "turn-end";
  data: string | null;
...
// otto/otto/api/types.py
export interface RealtimeResumingChat {
  id: string;
  chat_id: string;
  type: "resuming-chat";
  data: string | null;
...
// otto/otto/api/types.py
export interface RealtimeToolExecutionStart {
  id: string;
  chat_id: string;
